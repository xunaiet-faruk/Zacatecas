      ...
      <div className="container">
        <div className="row mt-5">
          <div className="col-6 col-md-6 relative">
            ...
            <Link to="/Park4" style={{textDecoration:'none'}} onClick={scrollToTop}><div className="arrow-button text-white">&#8594;</div></Link>
          ...
          <div className="col-6 col-md-6 relative">
            ...
            <Link to="/Park1" style={{textDecoration:'none'}} onClick={scrollToTop}><div className="arrow-button text-white">&#8594;</div></Link>
          </div>
        </div>
        ...
        <div className="row mt-3 mb-5 ">
          <div className="col-6 col-md-6 relative">
            ...
            <Link to="/Park2" style={{textDecoration:'none'}} onClick={scrollToTop}><div className="arrow-button text-white">&#8594;</div></Link>
          </div>
          <div className="col-6 col-md-6 relative">
            <img src="../assets/Air4.png" alt="" />
            <div className="Airport">Fresnillo Industrial Park II</div>
            <Link to="/Park3" style={{textDecoration:'none'}} onClick={scrollToTop}><div className="arrow-button text-white">&#8594;</div></Link>
          </div>
        </div>
      </div>
    </div>
