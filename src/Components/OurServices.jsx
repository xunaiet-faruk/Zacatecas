  ...
  return (
    <>
      <div className="container ">
        <h2 className="d-flex justify-content-center header-services mt-5">
          Our Services
        </h2>
        <div className="row mt-5">
          <div className="col-12 col-md-4 col-sm-12  d-flex justify-content-center flex-column align-items-center">
            ...
            <div className="Indus-card-heading mt-2">
          ...
          <div className="col-12 col-md-4 col-sm-12 d-flex justify-content-center flex-column align-items-center">
            ...
            <div className="Indus-card-heading mt-2">Built-To- Suit</div>
            <div className="Indus-card-para mt-2">
          ...
          <div className="col-12 col-md-4 col-sm-12 d-flex justify-content-center flex-column align-items-center">
            ...
            <div className="Indus-card-heading mt-2">Park Management</div>
            <div className="Indus-card-para mt-2">
        ...
        <div className="row mt-5">
          <div className="col-12 col-md-4 col-sm-12 d-flex justify-content-center flex-column align-items-center">
            ...
            <div className="Indus-card-heading mt-2">Site Selection</div>
            <div className="Indus-card-para mt-2">
          ...
          <div className="col-12 col-md-4 col-sm-12 d-flex justify-content-center flex-column align-items-center">
            ...
            <div className="Indus-card-heading mt-2">Soft Landing</div>
            <div className="Indus-card-para mt-2">
          ...
          <div className="col-12 col-md-4 col-sm-12 d-flex justify-content-center flex-column align-items-center">
            ...
            <div className="Indus-card-heading mt-2">Incentives</div>
            <div className="Indus-card-para mt-2">
      ...
      <p className='induspara'>{paragraph1}</p>
        ...
        <img src="../assets/City.png" alt=""  className="mt-5"/>
