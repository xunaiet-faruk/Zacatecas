...
export default function Countactus() {
  ...
  const sendEmail = (e) => {
    ...
    emailjs.sendForm('service_9xqhxd6', 'template_ysx3cai', form.current, {
  ...
  return (
    <div
      ...
      style={{
        width: "100%",
        backgroundImage: `url(../assets/contactback.png)`,
    ...
    >
      <div className="container mt-5 mb-5">
        <div className="row mt-5">
          <div className="col-12 col-md-6 col-sm-12 text-white">
            <h1>{heading}</h1>
          ...
          <div className="col-12 col-md-6 col-sm-12 res-mt">
            <div className="d-flex justify-content-center align-items-center flex-column box-form">
              <div className="container">
                <div className="mt-4 gettouch">{head}</div>
              </div>
