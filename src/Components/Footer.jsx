      ...
      <div className="col-lg-10 col-md-12">
        <div className="row" style={{ width: "100%" }}>
          ...
          <div className="col-lg-3 col-md-6 col-sm-6">
            ...
            ></div>
            <a href="https://sefin.zacatecas.gob.mx/" className="text-none d-flex align-items-center">
            <i class="fa-solid fa-shield-halved pe-2 fc"></i>
            <p style={serviceTextStyle}>
              {texts[selectedLanguage].financeSecretary}
            </p>
            </a>

            <a href="https://www.seduzac.gob.mx/" className="text-none d-flex">
            ...
            <a href="https://www.zacatecas.gob.mx/gobierno/dependencias/secturz/" className="text-none d-flex">
            ...
            <a href="https://www.saludzac.gob.mx/home/" className="text-none d-flex">
            ...
            <a href="https://funcionpublica.zacatecas.gob.mx/transparencia" className="text-none d-flex">
            <i class="fa-brands fa-servicestack pe-2 fc"></i>
            <p style={serviceTextStyle}>
            ...
            <a href="https://www.fiscaliazacatecas.gob.mx/" className="text-none d-flex">
